...
import "./ContainerFooterRework.css";

const ContainerFooterRework = () => {
  return (
    <div className="footer-dark">
      ...
      <div className="footer-dark-child" />
      ...
      <div className="join-our-mailing-list-parent">
        <div className="quick-links">Join our mailing list</div>
        <div className="frame-parent5">
          <div className="enter-email-wrapper">
            <div className="job-insurance">Enter Email</div>
          </div>
...
export default ContainerFooterRework;
